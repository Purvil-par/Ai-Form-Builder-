 ...
 * Strong closing call-to-action with gradient background
 */
const CTASection = () => {
    return (
        <section className="relative py-24 bg-dark-bg-alt overflow-hidden">
            {/* Animated Background Elements */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-0 right-0 w-96 h-96 bg-primary-600 opacity-15 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-secondary-500 opacity-15 rounded-full blur-3xl"></div>
            </div>
